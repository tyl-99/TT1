...
class EURJPYSTRATEGY:
    def __init__(self, target_pair="EUR/JPY"):
        ...
        self.pip_size = 0.01  # EUR/JPY pip size is 0.01 (same as USD/JPY)
        
        # BEST FROM EUR/JPY 50% WIN RATE TUNER: 46.8% win rate, 62 trades
    ...
    def print_filter_stats(self):
        ...
        if total == 0:
            return
        print(f"\n📊 EUR/JPY FIBONACCI STRATEGY - FILTER STATS:")
